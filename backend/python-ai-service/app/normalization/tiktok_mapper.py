...
def map_post(raw: dict, workspace_id: str) -> NormalizedPost:
    return NormalizedPost(
        canonical_id=make_canonical_id("tiktok", raw.get("source_post_id", "")),
        ...
        provenance={"source_platform": "tiktok", "fetched_at": raw.get("fetched_at", "")},
        raw_metadata=raw,
    )
...
def map_comment(raw: dict, post_canonical_id: str) -> NormalizedComment:
    return NormalizedComment(
        canonical_id=make_canonical_id("tiktok", raw.get("source_comment_id", "")),
        source_platform="tiktok",
